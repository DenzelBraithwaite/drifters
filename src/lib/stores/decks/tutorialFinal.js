...
const tutorialFinal = writable([
  ...
  // v-- Fast ending for those who don't wish to remember. Short ending --v
  {
    ...
    imgUrl: '/decks/tutorial/judicator-white.png',
    title: 'Jude',
    text: "You would doom us both simply out of fear of what your memories may hold? After meeting the guests, you're now hesistant on revealing your true self. But Jack, you are so close, all you have to do is remember and everything will be over.",
    faction: 'Friend',
  ...
  },
  {
    ...
    imgUrl: '/decks/tutorial/judicator-white.png',
    title: 'Jude',
    text: "Abandoned by all, this life was never fair to me, but then again, I suppose this is what I truly deserve... what we truly deserve Jack. You would have undederstood what I mean had you just remembered.",
    faction: '???',
  ...
  {
    id: 'tutorial-final-9',
    imgUrl: get(player).icons.health === 'heart' ? '/decks/special_chars/felix_dead.png' : '/decks/special_chars/melody_dead.png',
    title: get(player).icons.health === 'heart' ? 'Felix' : 'Melody',
    text: get(player).icons.health === 'heart' ? 'Heart momento, Felix.' : 'Diamond momento, Melody.',
    faction: 'Memories',
    textLeft: "", // ->tutorial-final-10
    textRight: "", // ->tutorial-final-10
    location: 'Memories',
    actionLeft: {
      good: 0,
      evil: 0,
  ...
  {
    id: 'tutorial-final-10',
    imgUrl: get(player).icons.aura === 'green' ? '/decks/special_chars/ziggy_dead.png' : '/decks/special_chars/bounder_dead.png',
    title: get(player).icons.aura === 'green' ? 'Ziggy' : 'Bounder',
    text: get(player).icons.aura === 'green' ? 'Green aura momento, Ziggy.' : 'Yellow aura momento, Bounder.',
    faction: 'Memories',
    textLeft: "", // ->tutorial-final-11
    textRight: "", // ->tutorial-final-11
    location: 'Memories',
    actionLeft: {
      good: 0,
      evil: 0,
  ...
  // Brain / Smiley
  {
    id: 'tutorial-final-11',
    imgUrl: get(player).icons.sanity === 'brain' ? '/decks/special_chars/bullisia_dead.png' : '/decks/special_chars/luna_dead.png',
    title: get(player).icons.sanity === 'brain' ? 'Eliza' : 'Luna',
    text: get(player).icons.sanity === 'brain' ? 'Brain momento, Eliza.' : 'Smiley momento, Luna.',
    faction: 'Memories',
    textLeft: "", // ->tutorial-final-12
    textRight: "", // ->tutorial-final-12
    location: 'Memories',
    actionLeft: {
      good: 0,
      evil: 0,
  ...
  // Knife / Cleaver
  {
    id: 'tutorial-final-12',
    imgUrl: get(player).icons.impulse === 'knife' ? '/decks/special_chars/shelly_dead.png' : '/decks/special_chars/marge_dead.png',
    title: get(player).icons.impulse === 'knife' ? 'Shelly' : 'Marge',
    text: get(player).icons.impulse === 'knife' ? 'Knife momento, Shelly.' : 'Cleaver momento, Marge.',
    faction: 'Memories',
  ...
  },
  {
    ...
    imgUrl: '/decks/tutorial/judicator-white.png',
    title: 'Jude',
    text: "I think deep down you know what I'm saying. The reason why you're here Jack, the reason why you're a guest and the reason why I have been assigned to you.",
    faction: 'Friend',
  ...
  },
  {
    ...
    imgUrl: '/decks/tutorial/judicator-white.png',
    title: 'Jude',
    text: "Your actions have revealed the truth in your heart and as a result, you unconsciously selected 4 mementos. Each of these mementos represent victims who's lives you stole. Four victims, four visitors and four stories unfinished.",
    faction: 'Friend',
  ...
  },
  {
    ...
    faction: 'Friend',
    textLeft: "I'm ready.", // ->tutorial-final-21
    textRight: "I am.", // ->tutorial-final-21
    location: 'Judgement',
    actionLeft: {
      good: 0,
      evil: 0,
  ...
  },
  {
    ...
    imgUrl: '/decks/special_chars/felix.png',
    title: 'Felix',
    text: "When you were only 12 years old, you took his life one day when he was out swimming alone by the lake. You followed him and pretended to make friends with him, claiming you knew where buried treasure was but you would need to swim to a secret island to find it. As soon as you two were isolated in the water, you drowned him with your bare hands and never spoke a word of it. The body was found the next day and you played the victim who lost a friend. You never told anyone about that day, soon after you never thought about it again.",
    faction: 'Memories',
  ...
  },
  {
    ...
    imgUrl: '/decks/chapter4/ziggy_real.png',
    title: 'Ziggy',
    text: "You guys would kick it together weekly. You'd watch moveis together, smoke together, play sports together, you were like brothers. At least, you were like a brother to him.",
    faction: 'Memories',
  ...
  },
  {
    ...
    title: 'Luna',
    text: "You slept with her then stabbed her in your car when you were finished. You dumped her on the street like trash, refusing to spend time hiding a body nobody would care about.",
    faction: 'Memories',
    textLeft: "I couldn't help myself...", // -> tutorial-final- brain / smiley
  ...
  },
  {
    ...
    imgUrl: '/decks/chapter4/shelly_real.png',
    title: 'Shelly',
    text: "You waited until she got off work one late night. You knocked her out from behind and dragged her to your basement. You kept her there for weeks, skinning her slowly as if disecting an animal for a science experiment.",
    faction: 'Memories',
  ...
  },
  {
    ...
    imgUrl: '/decks/chapter4/marge_real.png',
    title: 'Marge',
    text: "She was a veterinarian who had noticed your lack of empathy for animals. You feared she might expose you one day so you always kept her in mind as a future victim.",
    faction: 'Memories',
